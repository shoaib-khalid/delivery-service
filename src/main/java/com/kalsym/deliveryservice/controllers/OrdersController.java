...
//    @PreAuthorize("hasAnyAuthority('orders-get-pickuptime', 'all')")
    public ResponseEntity<HttpReponse> getPickupTime(HttpServletRequest request, @PathVariable("spId") Integer
            serviceProviderId, @PathVariable("pickupdate") String pickupdate) {
...
//    @PreAuthorize("hasAnyAuthority('orders-get-locationid', 'all')")
    public ResponseEntity<HttpReponse> getLocationId(HttpServletRequest
                                                             request, @PathVariable("postcode") String postcode, @PathVariable("productCode") String productCode) {
...
//    @PreAuthorize("hasAnyAuthority('orders-confirm-delivery', 'all')")
    public ResponseEntity<HttpReponse> submitOrder(HttpServletRequest request,
                                                   ...
                                                   @RequestBody SubmitDelivery submitDelivery) {
...
//    @PreAuthorize("hasAnyAuthority('bulk-orders-confirm-delivery', 'all')")
    public ResponseEntity<HttpReponse> batchSubmitDelivery(HttpServletRequest
                                                                   request, @RequestBody List<OrderConfirm> orderConfirm) throws InterruptedException {
...
//    @PreAuthorize("hasAnyAuthority('orders-cancel-order', 'all')")
    public ResponseEntity<HttpReponse> cancelOrder(HttpServletRequest
                                                           request, @PathVariable("order-id") Long orderId) {
...
//    @PreAuthorize("hasAnyAuthority('delivery-order-query', 'all')")
    public ResponseEntity<HttpReponse> queryOrder(HttpServletRequest
                                                          request, @PathVariable("order-id") Long orderId) {
...
//    @PreAuthorize("hasAnyAuthority('orders-query-order', 'all')")
    public ResponseEntity<HttpReponse> queryQuotation(HttpServletRequest
                                                              request, @PathVariable("order-id") Long orderId) {
        String logprefix = request.getRequestURI() + " ";
        String location = Thread.currentThread().getStackTrace()[1].getMethodName();
        HttpReponse response = new HttpReponse(request.getRequestURI());
    ...
    public ResponseEntity<HttpReponse> spCallback(HttpServletRequest
                                                          request, @Valid @RequestBody Object requestBody) {
        String logprefix = request.getRequestURI() + " ";
        String location = Thread.currentThread().getStackTrace()[1].getMethodName();
        HttpReponse response = new HttpReponse(request.getRequestURI());
...
//        LogUtil.info(logprefix, location, "", "");
    ...
    public ResponseEntity<HttpReponse> lalamoveCallback(HttpServletRequest
                                                                request, @RequestBody Map<String, Object> json) {
        HttpReponse response = new HttpReponse(request.getRequestURI());
        if (!json.isEmpty()) {
            String logprefix = request.getRequestURI() + " ";
            String location = Thread.currentThread().getStackTrace()[1].getMethodName();
...
//    @PreAuthorize("hasAnyAuthority('delivery-get-provider', 'all')")
    public ResponseEntity<HttpReponse> getDeliveryProvider(HttpServletRequest
                                                                   request, @PathVariable("type") String type, @PathVariable("country") String country) {
...
//    @PreAuthorize("hasAnyAuthority('delivery-rider-details', 'all')")
    public ResponseEntity<HttpReponse> getDeliveryRiderDetails(HttpServletRequest
                                                                       request, @PathVariable("orderId") String orderId) {
...
//    @PreAuthorize("hasAnyAuthority('get-provider-remarks', 'all')")
    public ResponseEntity<HttpReponse> getDeliveryProviderDetails
            (HttpServletRequest request, @PathVariable("providerId") String
                    providerId, @PathVariable("quantity") String quantity) {
        String logprefix = request.getRequestURI() + " ";
        String location = Thread.currentThread().getStackTrace()[1].getMethodName();
        HttpReponse response = new HttpReponse(request.getRequestURI());
...
//    @PreAuthorize("hasAnyAuthority('get-airwayBill-delivery', 'all')")
    public ResponseEntity<HttpReponse> getAirwayBill(HttpServletRequest
                                                             request, @PathVariable("orderId") String orderId) {
...
//    @PreAuthorize("hasAnyAuthority('add-priority-fee', 'all')")
    public ResponseEntity<HttpReponse> getAirwayBill(HttpServletRequest
                                                             request, @PathVariable("id") Long id) {
...
//    @PreAuthorize("hasAnyAuthority('get-delivery-type', 'all')")
    public ResponseEntity<HttpReponse> getDeliveryType
...
//    @PreAuthorize("hasAnyAuthority('get-delivery-vehicle-type', 'all')")
    public ResponseEntity<HttpReponse> getDeliveryVehicleType
            (HttpServletRequest request) {
...
//    @PreAuthorize("hasAnyAuthority('get-delivery-city', 'all')")
    public ResponseEntity<Set<String>> getCity(HttpServletRequest
                                                       request, @RequestBody Object json) {
...
//    @PreAuthorize("hasAnyAuthority('get-delivery-order-status-list', 'all')")
    public ResponseEntity<HttpReponse> getDeliveryOrderStatusList
    (HttpServletRequest request, @RequestParam(name = "orderId") String
            orderId) {
    ...
    public ResponseEntity<HttpReponse> getQuotationPrice
            (HttpServletRequest
                     request, @Valid @RequestBody List<Order> orderDetails) {
